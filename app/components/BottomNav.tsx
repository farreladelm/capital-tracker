...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-2 h-20 bg-surface/80 dark:bg-inverse-surface/80 backdrop-blur-xl rounded-t-xl shadow-[0_-4px_20px_rgba(76,75,198,0.06)] dark:shadow-[0_-4px_20px_rgba(0,0,0,0.04)]">
      {/* Home (Active) */}
