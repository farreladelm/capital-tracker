    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4 relative z-0">
      <div className="w-full max-w-lg rounded bg-surface-container-low border-[1.5px] border-outline-variant p-8 sm:p-12 shadow-sm relative z-10">
        <div className="mb-8 text-center">
          <h1 className="text-[32px] font-headline font-bold text-on-surface tracking-tight">Welcome Back</h1>
          <p className="text-on-surface-variant font-body mt-2">Log in to track your capital effortlessly</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm font-body text-on-surface-variant">
          Don&apos;t have an account? <Link href="/register" className="font-semibold text-primary hover:underline hover:text-primary-container">Sign up</Link>
        </p>
      </div>
